...
public class RangeDamageSpell extends TargetedSpell implements TargetedLocationSpell {
    ...
    public RangeDamageSpell(MagicConfig config, String spellName) {
        ...
        this.MinVRadius = getConfigDataDouble("min-v-radius", 0.0D);
        this.MinHRadius = getConfigDataDouble("min-h-radius", 0.0D);
